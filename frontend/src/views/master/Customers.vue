        ...
        <div v-if="showModal" class="modal-overlay" @click.self="showModal = false">
            <div class="modal" style="max-width: 700px;">
                <div class="modal-header">
                    <h3 class="modal-title">{{ editing ? 'Edit' : 'Add' }} Customer</h3>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row form-row-2">
                        <div class="form-group">
                            ...
                            <input v-model="form.code" class="input-field" :class="{ 'input-error': errors.code }" placeholder="e.g., CUS001" />
...
const form = reactive({
    code: '', name: '', name_bn: '', type: 'retail', contact_person: '', phone: '', mobile: '', email: '',
    address: '', city: '', state: '', gstin: '', credit_limit: 0, price_list: 'standard', is_active: true
})
